...
export const metadata: Metadata = {
  title: 'KIMA 자료 | KIMA 자료실',
  description: '총회자료, 회의록, 예산·결산자료, 정관 및 운영문서 등 KIMA 공식 자료를 공유합니다.',
}
...
export default async function KimaResourcesPage() {
    ...
    <div className="min-h-screen bg-[#F8F9FA]">
      ...
      <div className="bg-[#1B3A6B] text-white py-12 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-2xl font-bold">KIMA 자료</h1>
          <p className="mt-2 text-blue-200 text-sm">
            총회자료, 회의록, 예산·결산자료, 정관 및 운영문서 등 KIMA 공식 자료를 공유합니다.
          </p>
        </div>
      </div>
