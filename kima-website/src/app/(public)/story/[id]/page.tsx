              ...
              {canEdit && (
                <div className="shrink-0 flex items-center gap-2">
                  {editUrl && (
                    <Link
                      href={editUrl}
                      className="inline-flex items-center gap-1 px-3 py-1.5 border border-gray-200 rounded-lg text-xs font-medium text-gray-600 hover:bg-gray-50 hover:border-[#1B3A6B] hover:text-[#1B3A6B] transition-colors"
                    >
                  ...
                  <StoryDeleteButton storyId={story.id} backUrl={backUrl} />
                </div>
              )}
            </div>
