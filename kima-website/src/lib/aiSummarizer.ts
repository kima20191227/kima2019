...
{
  "relevance": <이주민·외국인 관련성 점수 0-100. 직접 관련 없으면 낮게>,
...
- 50 미만: 스포츠, 연예, 주식, 일반 사건, 개인 범죄 등 이주민 사역과 직접 관련 없는 기사
- 선거 후보자 발언, 출마 선언, 지지 호소, 공약 홍보 기사는 이주민·다문화 단어가 있어도 공식 법령·시행 정책이 아니면 50 미만으로 평가
- 이주민 사역에 직접 도움이 되는 법령, 제도 변경, 체류·비자, 노동, 교육, 복지, 상담, 인권, 통계·연구, 지역 지원사업 중심으로 평가
